(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (project-explorer bind-key company dash diminish epl git-commit org php-mode use-package web-mode which-key enh-ruby-mode rubocop evil-matchit evil-commentary coffee-mode ox-clip markdown-mode go-mode slime-company company-php php+-mode dockerfile-mode org-bullets evil-org org-evil evil-surround ac-cider ac-emmet ac-html ac-html-bootstrap ac-html-csswatcher aggressive-indent bug-hunter c-eldoc cider clojure-mode cmake-font-lock cmake-ide cmake-mode cmake-project column-marker company-c-headers company-mode dash-at-point dracula-theme el-get elm-mode emmet-mode ess evil evil-leader evil-magit evil-paredit exec-path-from-shell flymake-haskell-multi geeknote ghc go-eldoc graphviz-dot-mode haskell-mode help+ help-fns+ help-mode+ jade js2-mode linum-relative magit-gh-pulls magit-gitflow markdown-mode+ minimap omnisharp paredit powerline-evil rainbow-delimiters scala-mode shm simpleclip sly-macrostep sly-quicklisp sly-repl-ansi-color tagedit telephone-line xkcd yaml-mode ztree)))
