" Vim color file
" Maintainer: Michael Grubb <devel on dailyvoid period com>
" Based on symfony(http://juan.axisym3.net/vim-color-schemes/#symfony)
" by Juan frias <juandfrias at gmail dot com>
" Last Change: 2011 Apr 26
" Version: 1.0.0
" URL: https://github.com/mgrubb/dotfiles/raw/master/vim/colors/mg_symfony.vim
...
" Split area area
highlight StatusLine cterm=bold,reverse gui=bold,reverse,italic
...
highlight Folded ctermfg=236 ctermbg=248 guibg=#2f2f2f guifg=Grey gui=italic
highlight FoldColumn ctermfg=236 ctermbg=250 guibg=#2f2f2f guibg=Grey
...
" Syntax group
highlight Comment ctermfg=133 guifg=#bd48b3 gui=italic
...
highlight LineNr ctermfg=235 ctermbg=147 guifg=#2B2B2B guibg=#C0C0FF gui=italic
